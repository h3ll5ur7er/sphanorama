...
| [0063](0063-a-reload-waits-for-the-resident-spill-pair.md) | A reload waits about two seconds for its previous worker to release the resident spill pair before taking a tier of its own, because falling back at once made the capture it came back for unresumable. A second tab pays that wait on startup |
