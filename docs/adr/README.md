...
| [0059](0059-the-measurement-is-made-in-a-photograph.md) | Registration accuracy is measured in a licensed photograph rather than a checkerboard, the bytes are committed as received with a record beside them, and a checker fails the build for a binary that cannot say where it came from. 0058 is on a parallel branch |
